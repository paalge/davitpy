    ...
    **Example**:
    ...
    def overlayCnvCntrs(self):
        ...
        **Example**:
        ...
        #plot the contours
        xCnt, yCnt = self.mObj(lonCntr, latCntr, coords=self.data_coords)
    ...
    def overlayHMB(self, hmbCol='Gray'):
        ...
        **Example**:
        ...
        xVecHMB, yVecHMB = self.mObj( self.mapData.model.boundarymlon, 
            self.mapData.model.boundarymlat, coords=self.data_coords)
